...
export const TUTORIEL_SECTIONS: TutorielSection[] = [
  ...
  },
  {
    ...
    points: [
      'Visualisez les passages triés par mois contractuel (obligation, pas indicatif).',
      'Colonnes Date programmée et Statut (À programmer / Programmé / Réalisé / Hors mois). Filtre en haut.',
      'Cliquez une ligne → fiche affaire : date + durée (½ j ou 1 j) + équipe → le créneau apparaît au planning (bleu).',
      'Sync : bouger le créneau au planning met à jour le contrat ; retirer le créneau → « À programmer ».',
      'Hors mois contractuel : avertissement, pas de blocage. Bouton « Réalisée » clôture l’exercice.',
      'Alerte J-15 avant l’entretien. Les non programmés dont le mois est en cours ou passé sont signalés en rouge.',
    ],
